 ...
 */
contract MultisigNonRetrievable is Context, EIP712("Multisig", "0.0.1"), OwnerManager, ExecutorManager, TokenHolder {
    ...
    function generateTransaction(
        ...
        // 0xf2fde38b
        require(bytes4(data) != 0xf2fde38b, "Multisig/nonRetrievable: transferOwnership function is prohibited");

        // retrieve(address,address,uint256,string)
        // 0x1003dc14
        require(bytes4(data) != 0x1003dc14, "Multisig/nonRetrievable: retrieve function is prohibited");

        // retrieve(address,address,uint256,uint256,string)
        // 0x687fc0b5
        require(bytes4(data) != 0x687fc0b5, "Multisig/nonRetrievable: retrieve function is prohibited");
